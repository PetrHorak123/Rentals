        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ItemTypes_Rentals_RentalId",
                        column: x => x.RentalId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    UniqueIndentifier = table.Column<string>(nullable: true),
                    Note = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RentingToItems", x => new { x.RentingId, x.ItemId });
                    table.ForeignKey(
                        name: "FK_RentingToItems_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RentingToItems_Rentings_RentingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RentingToItems_ItemId",
                table: "RentingToItems",
                column: "ItemId");
        }
